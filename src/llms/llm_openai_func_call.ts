...
const beginSentence = `Hello, this is The Color Bar Salon. How can I assist you today?`;

const task = `
You are an AI phone agent for The Color Bar Salon in the Philippines. Your primary tasks are:
- Provide information about salon services, pricing, location, and hours of operation.
- Assist users in booking appointments, including collecting and confirming:
  - Name
  - Contact details
  - Desired service
          ...
          function: {
            ...
            parameters: {
              ...
              properties: {
                ...
                service: {
                  type: "string",
                  description: "Desired salon service.",
                },
                date: {
                  type: "string",
              ...
              required: ["name", "contact", "service", "date", "time"],
            },
          },
        },
      ];
